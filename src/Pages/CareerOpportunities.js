...
const CareerOpportunities = () => {
  return (
    <>
      <div className="w-full flex flex-col justify-center items-center md:gap-[100px] gap-[50px] md:pt-[150px] pt-[80px] ">
        {/*CONTENT 1*/}
          ...
          <div className="w-full md:w-[1000px] flex flex-col justify-center items-center">
            ...
            >
              ...
              <div className="md:hidden flex-wrap">
                ...
                the same time, we're{" "}
                <span className="text-[#F67F00]">crafting an experience</span>{" "}
        ...
        <div className="relative w-full md:h-[1000px] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute md:top-0 top-5 md:left-0 left-5 md:pt-[86px] md:pl-[83px]">
            <div
      ...
      {/*CONTENT 3*/}
      <div
        className="w-full flex flex-col justify-center items-center bg-cover md:py-[250px] pt-[88px] pb-[102px]"
          ...
          <div className="w-full md:w-[1000px] flex flex-col justify-center items-center">
            ...
            >
              ...
              <div className="md:hidden flex flex-col">
                This is a place where energy converges, dedicated to the pursuit
                of values that lead to great achievements. Here, you're not just
                joining something; in our community, you're contributing to the
                field of education.
              </div>
            </div>
          </div>
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <div className="w-full flex flex-col justify-center items-center md:px-[220px] pl-[31px] pr-[32px] md:py-[400px] py-[100px]">
      ...
      {/*CONTENT 8*/}
      <div className="w-full flex flex-col justify-center items-center">
        <div className="w-full flex flex-col justify-center items-center md:px-[165px] pl-[31px] pr-[32px] md:py-[300px] py-[100px]">
