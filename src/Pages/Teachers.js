...
const Teacher = () => {
  return (
    <>
      ...
      <div className="w-full flex flex-col justify-center items-center md:pt-[100px] pt-[50px] md:gap-[200px] gap-[100px] md:px-[220px] pl-[31px] pr-[32px] md:pb-[200px] pb-[100px]">
        {/*CONTENT 2*/}
      ...
      {/*CONTENT 8*/}
      <div className="w-full flex flex-col md:px-[220px] px-[113px] items-center md:pb-[200px] pb-[100px]">
