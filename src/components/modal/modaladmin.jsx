    ...
    <>
      {showModal3 ? (
        <>
          ...
          >
            <div
              className="relative w-full md:max-w-[900px] overflow-y-auto  my-auto md:py-[50px] flex modal-content"
                ...
                <div className="w-full flex flex-col md:gap-[50px] gap-[30px] md:py-[100px] py-[50px]">
                  <div className="md:w-[900px] w-full md:px-[100px] pl-[31px] pr-[32px] justify-start">
                    ...
                    >
                      ...
                      the institution. They set the direction, values, and
                      standards of excellence, ensuring a transformative school
                  ...
                  <div className="w-full md:w-[900px] flex flex-col md:pl-[100px] md:pr-[40px] pl-[31px] pr-[32px]">
                    <div className="w-full flex items-center ">
                      ...
                      >
                        The school owner, with our Kindertown management system,
                        has streamlined the student enrollment process and
                        efficiently tackled the busy administrative tasks of the
                ...
                <div className="w-full flex flex-col md:px-[100px] pl-[31px] pr-[32px] justify-center items-center md:pt-[100px] pt-[50px] md:gap-[50px] gap-[30px]">
                  ...
                  >
                    <ul className="list-outside list-disc flex flex-col md:gap-10 gap-5 md:pl-[50px] pl-[35px] text-left">
                      ...
                      <li>
                        Face to face training, online training and support.
                      </li>
                      <li>Referral Program.</li>
                      <li>
                        Delay pick-up / emergency pick-up protection feature.
                      </li>
