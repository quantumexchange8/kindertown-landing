        ...
        <>
            {AboutOpen ? (
                <>
                    ...
                    >
                        <div
                            className="relative w-full overflow-auto  my-auto md:py-[50px] flex justify-center modal-content"
                        ...
                        >
                            ...
                            {/*content*/}
                            <div className="border-0 md:rounded-[50px] relative flex flex-col bg-white outline-none focus:outline-none justify-center items-center md:pt-70 pt-[50px] md:pb-[150px] pb-[60px]">
                                <div className="md:w-[1000px] w-full flex flex-col gap-[100px] md:px-[100px]">
                                    <div className="flex flex-col md:gap-[30px] gap-[100px] ">
                                        <div className="flex flex-row flex-wrap justify-between">
                                            <img src={logo} alt="Logo" className="md:w-[150px] md:h-[100px]" />

                                            <button onClick={() => setAboutOpen(false)} className="justify-self-end">
                                                <img
                                                    src={close}
                                                    alt="CloseButton"
                                        ...
                                        <div className="w-full flex flex-col md:gap-5 gap-[15px] text-[#000]">
                                            <div
                                                className="md:w-[464px] md:h-auto md:text-[40px] text-xl leading-none"
                                    ...
                                    <div className="w-full flex flex-col md:gap-[150px] gap-[100px]">
                                        ...
                                        <div className="w-full flex flex-col gap-5 text-[#000]">
                                            <div
                                                className="md:text-[24px] text-base not-italic"
                                                style={{
                                        ...
                                        <div className="flex flex-col md:gap-[150px] gap-[100px] text-[#000]">
                                            ...
                                            <div className="flex flex-col gap-[50px]">
                                                <div
                                                    className="md:text-[40px] text-xl"
                                                    style={{ fontFamily: "SF Pro Display B" }}
                                                >
                                                    Our Service
                                                </div>
                                                <div
                                                    className="md:text-2xl text-base flex flex-col gap-[50px]"
                                                    style={{
                                                        fontFamily: "SF Pro Display M",
                                                        lineHeight: "normal",
                                                    }}
